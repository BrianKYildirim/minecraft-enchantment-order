"""
Core enchantment data: levels, weights, incompatibilities, applicable items.
"""
ENCHANTMENTS: dict[str, dict] = {
    ...
    "curse_of_vanishing": {
        ...
        "items": [
            ...
            "fishing_rod", "bow", "shears", "flint_and_steel",
            "carrot_on_a_stick", "warped_fungus_on_a_stick",
            "shield", "elytra", "pumpkin", "helmet", "trident",
